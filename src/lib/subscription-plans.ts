...
/**
 * NOTE: For server-side subscription limit checking (checkSubscriptionLimits),
 * see @/lib/subscription-limits.ts
 * This file only contains client-safe utilities and does not use server-side dependencies.
 */