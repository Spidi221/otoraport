...
export const landingMetadata: Metadata = {
  ...
  description: "Automatyzuj raportowanie cen mieszkań zgodnie z ustawą o ochronie nabywcy. Generuj raporty XML i Markdown automatycznie. Szybsze o 25% niż wykazcen.pl. Rozpocznij bezpłatny trial.",
  keywords: [
  ...
  "@graph": [
    {
      ...
      "name": "OTORAPORT",
      "description": "Automatyzacja raportowania cen mieszkań zgodnie z ustawą o ochronie nabywcy. System dla deweloperów generujący raporty XML i Markdown.",
      "url": "https://otoraport.pl",
      ...
      "featureList": [
        "Automatyczne generowanie raportów XML i Markdown",
    ...
    },
    {
      ...
      "description": "Usługa automatycznego generowania raportów cen mieszkań zgodnych z wymogami ustawy o ochronie nabywcy",
      "provider": {
        "@id": "https://otoraport.pl/#organization" 
      },
      "areaServed": {
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "OTORAPORT automatycznie generuje raporty XML i Markdown zgodne z ustawą o ochronie nabywcy. Wystarczy wgrać plik z cenami raz w miesiącu, a system automatycznie aktualizuje wszystkie raporty i udostępnia je ministerstwu przez stałe linki."
          }
        },
        {
          "@type": "Question", 
