-- ========================================================================
-- DODANIE PRZYKŁADOWYCH DANYCH (POPRAWIONE - bez kolumny address)
-- ========================================================================
...
BEGIN
    ...
    -- Wstaw projekt testowy (bez kolumny address)
    ...
    -- Dodaj 3 przykładowe mieszkania (tylko z kolumnami które istnieją)
